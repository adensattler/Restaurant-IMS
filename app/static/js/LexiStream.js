 ...
 */
    ...
    class LexiStream {
        ...
        displayLoading(show) {
            ...
            // scrolls to bottom of the messages window on new user message!
            this.box.lastElementChild.scrollIntoView({ behavior: 'smooth' });
        }
        ...
        stopStream() {
            ...
            // scrolls to bottom of the messages window on completed  assistant message!
